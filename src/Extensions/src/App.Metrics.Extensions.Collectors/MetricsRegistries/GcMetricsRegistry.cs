...
namespace App.Metrics.Extensions.Collectors.MetricsRegistries
{
    public static class GcMetricsRegistry
    {
        ...
        public static class Gauges
        {
            ...
            public static readonly GaugeOptions PinnedObjectHeapSize = new GaugeOptions
            {
                Context = ContextName,
                Name = "Pinned Object Heap Size",
                MeasurementUnit = Unit.Bytes
            };
            ...
            public static readonly GaugeOptions BytesSurvivedPinnedoObjectHeap = new GaugeOptions
            {
                Context = ContextName,
                Name = "Bytes Survived Pinned Object Heap",
                MeasurementUnit = Unit.Bytes
            };

            public static readonly GaugeOptions PinnedObjects = new GaugeOptions
            {
                Context = ContextName,
                Name = "Pinned Objects",
                MeasurementUnit = Unit.Items
            };
            public static readonly GaugeOptions Handles = new GaugeOptions
            {
                Context = ContextName,
                Name = "Handles Count",
                MeasurementUnit = Unit.Items
